// ======================================================================
// Teil3.v generated from TopDesign.cysch
// 07/02/2018 at 18:56
...
// PGA_v2_0(Gain=1, Power=3, VddaValue=5, Vref_Input=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PGA_v2_0, CY_CONFIG_TITLE=PGA_Druck, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_Druck, CY_INSTANCE_SHORT_NAME=PGA_Druck, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PGA_Druck, )
module PGA_v2_0_0 (
    Vin,
    Vref,
    Vout);
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=255, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=4080, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC8_Druck, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_Druck, CY_INSTANCE_SHORT_NAME=VDAC8_Druck, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=VDAC8_Druck, )
...
module CharLCD_v2_20_4 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("bcae6b11-a71e-4249-9a9d-509b806f537b/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=2, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=4479, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=true, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=1, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=44789, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_1, CY_INSTANCE_SHORT_NAME=PWM_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PWM_1, )
module PWM_v3_30_10 (
    reset,
    clock,
    tc,
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=4095, CONTROL3=0, ControlRegRemoved=1, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4095, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=true, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Counter_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_1, CY_INSTANCE_SHORT_NAME=Counter_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Counter_1, )
...
module top ;
    ...
    PGA_v2_0_0 PGA_Druck (
        .Vin(Net_1),
        .Vref(Net_6),
        .Vout(Net_7));

    VDAC8_v1_90_1 VDAC8_Druck (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_6));
    defparam VDAC8_Druck.Data_Source = 0;
    defparam VDAC8_Druck.Initial_Value = 255;
    defparam VDAC8_Druck.Strobe_Mode = 0;

    ADC_SAR_v3_10_2 ADC_Druck (
        .vplus(Net_7),
        .vminus(Net_17),
        .soc(1'b0),
        .eoc(Net_10),
	...
	wire [0:0] tmpOE__SensorPin_net;
	wire [0:0] tmpFB_0__SensorPin_net;
	wire [0:0] tmpIO_0__SensorPin_net;
	wire [0:0] tmpINTERRUPT_0__SensorPin_net;
	electrical [0:0] tmpSIOVREF__SensorPin_net;
	...
	cy_psoc3_pins_v1_10
		...
		SensorPin
		 (.oe(tmpOE__SensorPin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SensorPin_net[0:0]}),
		  .analog({Net_1}),
		  .io({tmpIO_0__SensorPin_net[0:0]}),
		  .siovref(tmpSIOVREF__SensorPin_net),
		  .interrupt({tmpINTERRUPT_0__SensorPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SensorPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam VDAC8_1.Initial_Value = 208;
    ...
    VDAC8_v1_90_8 VDAC8_2 (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_248));
    defparam VDAC8_2.Data_Source = 0;
    defparam VDAC8_2.Initial_Value = 104;
    defparam VDAC8_2.Strobe_Mode = 0;

	wire [0:0] tmpOE__Compare_Pin_net;
	wire [0:0] tmpFB_0__Compare_Pin_net;
	wire [0:0] tmpIO_0__Compare_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Compare_Pin_net;
	electrical [0:0] tmpSIOVREF__Compare_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("e92db766-a57b-40de-834b-a8d810a553d7"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Compare_Pin
		 (.oe(tmpOE__Compare_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Compare_Pin_net[0:0]}),
		  .analog({Net_79}),
		  .io({tmpIO_0__Compare_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Compare_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Compare_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Compare_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OutputDischarge_Pin_net;
	wire [0:0] tmpFB_0__OutputDischarge_Pin_net;
	wire [0:0] tmpIO_0__OutputDischarge_Pin_net;
	wire [0:0] tmpINTERRUPT_0__OutputDischarge_Pin_net;
	electrical [0:0] tmpSIOVREF__OutputDischarge_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		OutputDischarge_Pin
		 (.oe(tmpOE__OutputDischarge_Pin_net),
		  .y({Net_225}),
		  .fb({tmpFB_0__OutputDischarge_Pin_net[0:0]}),
		  .io({tmpIO_0__OutputDischarge_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__OutputDischarge_Pin_net),
		  .interrupt({tmpINTERRUPT_0__OutputDischarge_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OutputDischarge_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- SRFF Start --
    reg  cy_srff_1;
    always @(posedge Net_8)
    begin
        cy_srff_1 <= (Net_43 | Net_225) & ~Net_67;
    end
    assign Net_225 = cy_srff_1;
    // -- SRFF End --
	...
	cy_psoc3_pins_v1_10
		#(.id("cc899d2b-5e67-4c8f-ab0e-fd4196f4a487"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    assign Net_1241 = ~Net_211;

	wire [0:0] tmpOE__V_t_net;
	wire [0:0] tmpFB_0__V_t_net;
	wire [0:0] tmpIO_0__V_t_net;
	wire [0:0] tmpINTERRUPT_0__V_t_net;
	electrical [0:0] tmpSIOVREF__V_t_net;

	cy_psoc3_pins_v1_10
		#(.id("c6782651-2cf9-49b2-a20c-ded9fa2714a4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		V_t
		 (.oe(tmpOE__V_t_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_t_net[0:0]}),
		  .analog({Net_44}),
		  .io({tmpIO_0__V_t_net[0:0]}),
		  .siovref(tmpSIOVREF__V_t_net),
		  .interrupt({tmpINTERRUPT_0__V_t_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V_t_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
