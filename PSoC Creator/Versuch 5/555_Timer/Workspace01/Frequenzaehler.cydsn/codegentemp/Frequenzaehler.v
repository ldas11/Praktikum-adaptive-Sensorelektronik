// ======================================================================
// Frequenzaehler.v generated from TopDesign.cysch
// 06/18/2018 at 17:00
...
module CharLCD_v2_20_5 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("40755395-f7c6-41ba-92a8-352ac1cd2d64/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Osci_net;
	wire [0:0] tmpFB_0__Osci_net;
	wire [0:0] tmpIO_0__Osci_net;
	wire [0:0] tmpINTERRUPT_0__Osci_net;
	electrical [0:0] tmpSIOVREF__Osci_net;

	cy_psoc3_pins_v1_10
		#(.id("ea6b80f6-af6e-4c52-8499-ac009da7b32e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Osci
		 (.oe(tmpOE__Osci_net),
		  .y({Net_212}),
		  .fb({tmpFB_0__Osci_net[0:0]}),
		  .io({tmpIO_0__Osci_net[0:0]}),
		  .siovref(tmpSIOVREF__Osci_net),
		  .interrupt({tmpINTERRUPT_0__Osci_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Osci_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_7 UART_1 (
        ...
        .reset(1'b0),
        .rx(1'b0),
        .tx_interrupt(Net_1669),
        .rx_interrupt(Net_1670),
        .tx_data(Net_1671),
        .tx_clk(Net_1672),
        .rx_data(Net_1673),
        .rx_clk(Net_1674));
