...
void LCD_1_PrintString(char8 const string[]) ;
...
void LCD_1_Wakeup(void) ;
    ...
    void  LCD_1_LoadCustomFonts(uint8 const customData[])
                        ;
    ...
    void LCD_1_PrintInt8(uint8 value) ;
    void LCD_1_PrintInt16(uint16 value) ;
    void LCD_1_PrintInt32(uint32 value) ;
    void LCD_1_PrintNumber(uint16 value) ; 
    void LCD_1_PrintU32Number(uint32 value) ;
...
#define LCD_1_PrintNumber(value) LCD_1_PrintU32Number((uint16) (value))
...
extern uint8 const CYCODE LCD_1_customFonts[64u];
...
#define LCD_1_DISPLAY_SCRL_LEFT        (0x18u)
#define LCD_1_DISPLAY_SCRL_RIGHT       (0x1Eu)
...
#if(LCD_1_CONVERSION_ROUTINES == 1u)
    #define LCD_1_NUMBER_OF_REMAINDERS_U32 (0x0Au)
    #define LCD_1_TEN                      (0x0Au)
    #define LCD_1_8_BIT_SHIFT              (8u)
    #define LCD_1_32_BIT_SHIFT             (32u)
    #define LCD_1_ZERO_CHAR_ASCII          (48u)
#endif /* LCD_1_CONVERSION_ROUTINES == 1u */
...
#define LCD_1_LONGEST_CMD_US           (0x651u)
#define LCD_1_WAIT_CYCLE               (0x10u)
#define LCD_1_READY_DELAY              ((LCD_1_LONGEST_CMD_US * 4u)/(LCD_1_WAIT_CYCLE))
...
/* Device specific registers */
    ...
    #define LCD_1_PORT_DR_REG           (*(reg32 *) LCD_1_LCDPort__DR)  /* Data Output Register */
    #define LCD_1_PORT_DR_PTR           ( (reg32 *) LCD_1_LCDPort__DR)
    #define LCD_1_PORT_PS_REG           (*(reg32 *) LCD_1_LCDPort__PS)  /* Pin State Register */
    #define LCD_1_PORT_PS_PTR           ( (reg32 *) LCD_1_LCDPort__PS)
    
    #define LCD_1_PORT_PC_REG           (*(reg32 *) LCD_1_LCDPort__PC)
    #define LCD_1_PORT_PC_PTR           (*(reg32 *) LCD_1_LCDPort__PC)
...
#if (0 == LCD_1_LCDPort__SHIFT)
    #define LCD_1_PORT_SHIFT               (0x00u)
#else
    #define LCD_1_PORT_SHIFT               (0x01u)
#endif /* (0 == LCD_1_LCDPort__SHIFT) */

#define LCD_1_PORT_MASK                ((uint8) (LCD_1_LCDPort__MASK))

#if (CY_PSOC4)

    #define LCD_1_DM_PIN_STEP              (3u)
    ...
    */
    #define LCD_1_HIGH_Z_DATA_DM           ((0x00000249ul) << (LCD_1_PORT_SHIFT *\
                                                                          LCD_1_DM_PIN_STEP))
    #define LCD_1_STRONG_DATA_DM           ((0x00000DB6ul) << (LCD_1_PORT_SHIFT *\
                                                                          LCD_1_DM_PIN_STEP))
    #define LCD_1_DATA_PINS_MASK           (0x00000FFFul)
    #define LCD_1_DM_DATA_MASK             ((uint32) (LCD_1_DATA_PINS_MASK << \
                                                      (LCD_1_PORT_SHIFT * LCD_1_DM_PIN_STEP)))
...
/* Pin Masks */
#define LCD_1_RS                     ((uint8) \
                                                (((uint8) 0x20u) << LCD_1_LCDPort__SHIFT))
#define LCD_1_RW                     ((uint8) \
                                                (((uint8) 0x40u) << LCD_1_LCDPort__SHIFT))
#define LCD_1_E                      ((uint8) \
                                                (((uint8) 0x10u) << LCD_1_LCDPort__SHIFT))
#define LCD_1_READY_BIT              ((uint8) \
                                                (((uint8) 0x08u) << LCD_1_LCDPort__SHIFT))
#define LCD_1_DATA_MASK              ((uint8) \
                                                (((uint8) 0x0Fu) << LCD_1_LCDPort__SHIFT))
...
***************************************/
    ...
    */
    #define LCD_1_PrintDecUint16(x)   LCD_1_PrintNumber(x)  
    #define LCD_1_PrintHexUint8(x)    LCD_1_PrintInt8(x)
    #define LCD_1_PrintHexUint16(x)   LCD_1_PrintInt16(x)        
